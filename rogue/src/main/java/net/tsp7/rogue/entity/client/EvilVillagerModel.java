...
public class EvilVillagerModel<T extends EvilVillagerEntity> extends SinglePartEntityModel<T> {
    private final ModelPart body;
    private final ModelPart head;

    public EvilVillagerModel(ModelPart root) {
    ...
    @Override
    public void setAngles(EvilVillagerEntity entity, float limbAngle, float limbDistance, float animationProgress, float netHeadYaw, float headPitch) {
